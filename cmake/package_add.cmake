macro(package_add_test TESTGROUP TESTNAME)
    ...
    target_link_libraries(${TESTNAME} pthread gtest gmock gtest_main ${XRT_OPENCL_XDP_LIB} ${XRT_CORE_LIB} ${XRT_OPENCL_LIB} ${Boost_LIBRARIES})
...
macro(package_add_example EXAMPLEGROUP EXAMPLENAME)
    ...
    target_link_libraries(${EXAMPLENAME} pthread ${XRT_OPENCL_XDP_LIB} ${XRT_CORE_LIB} ${XRT_OPENCL_LIB} ${Boost_LIBRARIES})
